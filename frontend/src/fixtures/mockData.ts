...
export const PARTS: Record<string, Part> = {
  ...
  part_water_filter: {
    ...
    price: 38000,
    in_stock: true,
    image: svgThumb('#16A6B6'),
  },
  part_hepa: {
    id: 'part_hepa',
    name: '공기청정기 HEPA 교체 필터',
    sku: 'CFX-G100',
    price: 45000,
    in_stock: false,
    image: svgThumb('#8B5CF6'),
  },
};
...
export const PRODUCTS: Product[] = [
  {
    ...
    model: 'AX9500',
    price: 599000,
    specs: { coverage: '60㎡', noise: '22dB', filter: '3중 HEPA' },
    in_stock: true,
    image: svgThumb('#1FA463'),
    reason: '거실 면적·저소음 선호 추천',
  },
  {
    id: 'prod_washer_bespoke',
    category: 'washer',
    name: '비스포크 그랑데 AI 세탁기',
    model: 'WF24B9600',
    price: 1490000,
    specs: { capacity: '24kg', noise: '저소음', ai: 'AI 맞춤세탁' },
    in_stock: true,
    image: svgThumb('#0257D8'),
    reason: '노후 세탁기 교체 후보',
  },
];
...
export const SOLUTIONS: { match: RegExp; label: string; solution: Solution }[] = [
  ...
  {
    match: /타는 냄새|탄내|스파크|연기|감전|가스|인덕션/,
    label: '인덕션 안전 위험',
  ...
  },
  {
    ...
    label: '냉장고 정수필터',
    solution: {
      required_parts: ['part_water_filter'],
      coverage: 'free',
      steps: [
        { order: 1, instruction: '정수필터 표시등을 확인하세요.', safety: 'none' },
        {
          order: 2,
          instruction: '필터를 반시계로 돌려 분리 후 새 필터로 교체하세요.',
          safety: 'none',
        },
      ],
    },
...
export const SEED_ORDERS = [
  {
    id: 'ord_seed_1',
    status: 'DELIVERED',
    items: [{ part_id: 'part_drain_filter', name: '세탁기 배수 필터', qty: 1, price: 12000 }],
    total: 15000,
