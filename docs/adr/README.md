...
| [0064](0064-experiments-ab.md) | **실험·롤아웃(Runtime A/B)** — 결정적 sticky 할당·실험 레지스트리·canary/홀드아웃 게이트·노출 로깅(analytics append)·FE 훅/BE 헬퍼(`/internal/experiments/*`). `EXPERIMENTS` off=회귀 불변 | 채택 |
